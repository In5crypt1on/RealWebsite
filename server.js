...
// --- Static File Serving ---
// Serve static files from the current directory (the 'Website' folder)
app.use(express.static(__dirname));

app.get('/', (req, res) => {
    res.sendFile(path.join(__dirname, 'X-15-Website.html'));
});
...
// The catch-all route was removed as it's no longer needed with specific routes.
// Express's `express.static` will handle serving all other HTML files.